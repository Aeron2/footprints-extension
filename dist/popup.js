...
var Test = function Test() {
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),
    ...
    newTag = _useState4[0],
    setNewTag = _useState4[1];
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),
    _useState6 = _slicedToArray(_useState5, 2),
    blok = _useState6[0],
    setBlok = _useState6[1];
  var predefinedTags = ["Music", "Podcasts", "Artists", "Albums", "Radio", "Charts", "Playlists", "Episodes"];
  var handleAddTag = function handleAddTag() {
    if (newTag.trim()) {
      setTags([].concat(_toConsumableArray(tags), [newTag]));
      setNewTag("");
    }
  };
  var handleCreateBookmark = function handleCreateBookmark() {
    // Logic to create a bookmark
    console.log("Creating bookmark with tags:", tags, "and blok:", blok);
  };
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
  ...
  }, predefinedTags.map(function (tag) {
    ...
    value: blok,
    onChange: function onChange(e) {
      return setBlok(e.target.value);
    },
    className: "w-full p-2 border rounded"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("option", {
    value: ""
  }, "Add to a blok"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
